...
//        Cursor cursor = db.rawQuery("SELECT * FROM " + TABLE_NAME, null);
//        Log.d("我在這~~~~~~~~~~", editTextId.getText().toString());
////        cursor.moveToPosition(Integer.valueOf(editTextId.getText().toString().trim()));
//
////        Log.d("cursorgetPosition~~~~~~", String.valueOf(cursor.getPosition()));
//        cursor.moveToLast();
//        courseName.setText(cursor.getString(1));
//        cursor.moveToFirst();
//        Log.d("cursorgetPosition~~~~~~", String.valueOf(cursor.moveToFirst()));
